...
# Ensure local project repository is prioritized over installed site-packages
...
def main():
    ...
    # Prevent uncaught Qt slot exceptions from abruptly crashing the application
    def custom_excepthook(exc_type, exc_value, exc_traceback):
        if issubclass(exc_type, KeyboardInterrupt):
            sys.__excepthook__(exc_type, exc_value, exc_traceback)
            return
        logger.error("Excepción no capturada en GUI interceptada:", exc_info=(exc_type, exc_value, exc_traceback))
